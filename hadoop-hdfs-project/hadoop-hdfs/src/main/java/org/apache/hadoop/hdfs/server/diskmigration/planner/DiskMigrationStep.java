...
/**
 * Migration step is a step that planner can execute that will move data from one
 * volume to another.
 */
public class DiskMigrationStep implements Step {
  ...
  private long tolerancePercent = 0;
   ...
   */
  public DiskMigrationStep(DiskBalancerVolume sourceVolume, DiskBalancerVolume destinationVolume,
                           long bytesToMove, String volumeSetID) {
