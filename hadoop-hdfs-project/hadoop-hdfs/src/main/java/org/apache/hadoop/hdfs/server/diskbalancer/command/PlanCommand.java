...
public class PlanCommand extends Command {
  ...
  public PlanCommand(Configuration conf, final PrintStream ps) {
    ...
    addValidCommandParameters(DiskBalancerCLI.PLAN_TYPE, "Plan Type");
  ...
  public void execute(CommandLine cmd) throws Exception {
    ...
    if (cmd.hasOption(DiskBalancerCLI.PLAN_TYPE)) {
      this.type = cmd.getOptionValue(DiskBalancerCLI.PLAN_TYPE);
    }
    ...
    NodePlan plan = null;
    List<NodePlan> plans = getCluster().computePlan(this.type, this.thresholdPercentage);
    setPlanParams(plans);
